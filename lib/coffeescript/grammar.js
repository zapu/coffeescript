...
(function() {
  ...
  grammar = {
    ...
    FuncDirective: [o('YieldReturn'), o('CoffeeAwaitReturn')],
    ...
    IcedAwait: [
      o('AWAIT Block',
      function() {
        return new IcedAwait($2);
      }),
      o('AWAIT Expression',
      function() {
        return new IcedAwait(Block.wrap([$2]));
      })
    ],
    ...
    Expression: [o('Value'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield'), o('Defer')],
    Yield: [
      o('YIELD',
      function() {
        return new Op($1,
    ...
    CoffeeAwaitReturn: [
      o('COFFEE_AWAIT RETURN Expression',
      function() {
        return new CoffeeAwaitReturn($3);
      }),
      o('COFFEE_AWAIT RETURN',
      function() {
        return new CoffeeAwaitReturn;
      })
    ],
  ...
  //     (2 + 3) * 4
  operators = [['left', '.', '?.', '::', '?::'], ['left', 'CALL_START', 'CALL_END'], ['nonassoc', '++', '--'], ['left', '?'], ['right', 'UNARY'], ['right', 'COFFEE_AWAIT'], ['right', '**'], ['right', 'UNARY_MATH'], ['left', 'MATH'], ['left', '+', '-'], ['left', 'SHIFT'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', '&'], ['left', '^'], ['left', '|'], ['left', '&&'], ['left', '||'], ['left', 'BIN?'], ['nonassoc', 'INDENT', 'OUTDENT'], ['right', 'YIELD'], ['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS'], ['right', 'FORIN', 'FOROF', 'FORFROM', 'BY', 'WHEN'], ['right', 'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS', 'IMPORT', 'EXPORT'], ['left', 'POST_IF'], ['right', 'AWAIT']];
