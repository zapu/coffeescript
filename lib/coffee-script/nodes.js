...
(function() {
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    Obj.prototype.icedToSlot = function(i) {
      var access, prop, _i, _len, _ref4, _results;
      _ref4 = this.properties;
      _results = [];
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        prop = _ref4[_i];
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.icedCompileIced = function(o, d) {
      var a1, a2, a3, a4, a5, b, body, condition, empty_arr, guard, iname, init, ival, key, key_lit, key_val, keys, keys_access, keys_len, keys_val, kval, len, len_rhs, len_val, loop_body, loop_keys, loop_source, pos, pre_body, ref, ref_val, ref_val_copy, rop, rvar, scope, source_access, step;
      body = d.body;
      condition = null;
      init = [];
      step = null;
      ...
      if (this.object) {
        ...
        pos = this.source.base.from <= this.source.base.to;
        rop = this.source.base.exclusive ? (pos ? '<' : '>') : (pos ? '<=' : '>=');
        condition = new Op(rop, this.name, this.source.base.to);
        init = [new Assign(this.name, this.source.base.from)];
        if (this.step != null) {
          step = new Op((pos ? "+=" : "-="), this.name, this.step);
        } else {
          step = new Op((pos ? '++' : "--"), this.name);
        }
      } else if (!this.range && this.name) {
