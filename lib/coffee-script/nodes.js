...
(function() {
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.icedCompileIced = function(o, d) {
      var a1, a2, a3, a4, a5, b, begin, body, condition, empty_arr, end, guard, iname, init, ival, key, key_lit, key_val, keys, keys_access, keys_len, keys_val, kval, len, len_rhs, len_val, loop_body, loop_keys, loop_source, neg, pos, positive, pre_body, ref, ref_val, ref_val_copy, rvar, scope, source_access, step, stepVal;
      body = d.body;
      condition = null;
      init = [];
      step = null;
      ...
      if (this.object) {
        ...
        if (this.source.base.exclusive) {
          pos = new Op("&&", new Op("===", positive, new Literal(true)), new Op(">=", this.name, this.source.base.to));
          neg = new Op("&&", new Op("===", positive, new Literal(false)), new Op("<=", this.name, this.source.base.to));
