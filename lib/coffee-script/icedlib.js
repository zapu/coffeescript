...
(function() {
  ...
  exports.Pipeliner = Pipeliner = (function() {
    ...
    Pipeliner.prototype.waitInQueue = function(cb) {
      var ___iced_passed_deferral, __iced_deferrals, _break, _continue, _next, _while,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(__iced_k) {
    ...
    Pipeliner.prototype.flush = function(autocb) {
      var ___iced_passed_deferral, __iced_deferrals, _break, _continue, _next, _results, _while,
        _this = this;
      __iced_k = autocb;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      _results = [];
