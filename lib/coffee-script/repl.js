...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, iced, icedmod, merge, nodeREPL, path, replDefaults, updateSyntaxError, vm, __iced_k, __iced_k_noop, _ref;
  ...
  replDefaults = {
    ...
    "eval": function(input, context, filename, cb) {
      ...
      context.iced = iced;
      context[icedmod["const"].k_noop] = function() {};
      run = function(js) {
        if (context === global) {
            ...
            if (ast.icedIsCpsPivot()) {
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  ...
                  filename: "/Users/max/src/coffee-script/src/repl.coffee"
                });
