...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, iced, icedmod, merge, nodeREPL, path, replDefaults, updateSyntaxError, vm, _ref;
  ...
  replDefaults = {
    ...
    "eval": function(input, context, filename, cb) {
      ...
      try {
        ...
        if (ast.icedIsCpsPivot()) {
          ret = null;
          context[icedmod["const"].k] = function() {
            return cb(null, ret);
          };
          ret = run(js);
          return;
