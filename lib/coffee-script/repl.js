...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, fs, iced, icedmod, merge, nodeREPL, path, prettyErrorMessage, replDefaults, updateSyntaxError, vm, __iced_k, __iced_k_noop, _ref;
  ...
  _ref = require('./helpers'), merge = _ref.merge, prettyErrorMessage = _ref.prettyErrorMessage, updateSyntaxError = _ref.updateSyntaxError;
  ...
  replDefaults = {
    ...
    "eval": function(input, context, filename, cb) {
      var Assign, Block, Literal, Value, ast, err, js, run, ___iced_passed_deferral, __iced_k, _ref1;
      ...
      run = function(js) {
        if (context === global) {
          return vm.runInContext(js, filename);
        } else {
