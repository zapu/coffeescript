...
(function() {
  ...
  var Access, Arr, Assign, Base, Block, BooleanLiteral, CSXTag, Call, Class, Code, CodeFragment, CoffeeAwaitReturn, Defer, ExecutableClassBody, Existence, Expansion, ExportAllDeclaration, ExportDeclaration, ExportDefaultDeclaration, ExportNamedDeclaration, ExportSpecifier, ExportSpecifierList, Extends, For, FuncGlyph, HereComment, HoistTarget, IcedAwait, IcedRuntime, IdentifierLiteral, If, ImportClause, ImportDeclaration, ImportDefaultSpecifier, ImportNamespaceSpecifier, ImportSpecifier, ImportSpecifierList, In, Index, InfinityLiteral, JS_FORBIDDEN, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, LineComment, Literal, ModuleDeclaration, ModuleSpecifier, ModuleSpecifierList, NEGATE, NO, NaNLiteral, NullLiteral, NumberLiteral, Obj, Op, Param, Parens, PassthroughLiteral, PropertyName, Range, RegexLiteral, RegexWithInterpolations, Return, SIMPLENUM, Scope, Slice, Slot, Splat, StatementLiteral, StringLiteral, StringWithInterpolations, Super, SuperCall, Switch, TAB, THIS, TaggedTemplateCall, ThisLiteral, Throw, Try, UTILITIES, UndefinedLiteral, Value, While, YES, YieldReturn, addDataToNode, attachCommentsToNode, compact, del, ends, extend, flatten, fragmentsToText, hasLineComments, iced, indentInitial, isLiteralArguments, isLiteralThis, isUnassignable, locationDataToString, merge, moveComments, multident, quote_funcname_for_debug, quote_path_for_emission, require_top_dir, shouldCacheOrIsAssignable, some, starts, strToJavascript, throwSyntaxError, unfoldSoak, unshiftAfterComments, utility,
    indexOf = [].indexOf,
    splice = [].splice,
    slice = [].slice;
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, strToJavascript} = require('./helpers'));
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      icedFlattenChildren() {
        var attr, child, j, k, len1, len2, out, ref1, ref2;
        out = [];
        ref1 = this.children;
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          attr = ref1[j];
      ...
      containsAwait() {
        return this.contains(function(node) {
          return node instanceof IcedAwait;
        });
      }
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileComments(fragments) {
        var code, commentFragment, fragment, fragmentIndent, fragmentIndex, indent, j, k, len1, len2, len3, newLineIndex, onNextLine, pastFragment, pastFragmentIndex, q, r, ref1, ref2, ref3, ref4, t, trail, upcomingFragment, upcomingFragmentIndex;
        for (fragmentIndex = j = 0, len1 = fragments.length; j < len1; fragmentIndex = ++j) {
          ...
          if (fragment.precedingComments) {
            ...
            for (pastFragmentIndex = q = ref2.length - 1; q >= 0; pastFragmentIndex = q += -1) {
          ...
          if (fragment.followingComments) {
            ...
            for (upcomingFragmentIndex = t = 0, len3 = ref4.length; t < len3; upcomingFragmentIndex = ++t) {
      ...
      icedAddRuntime(deferInFile, awaitInFile) {
        var index, node;
        index = 0;
        while ((node = this.expressions[index]) && node instanceof LineComment || node instanceof Value && node.isString()) {
          index++;
        }
  ...
  exports.ThisLiteral = ThisLiteral = class ThisLiteral extends Literal {
    ...
    compileNode(o) {
      ...
      if (((ref2 = o.scope.method) != null ? ref2.icedContext : void 0) != null) {
        code = o.scope.method.icedContext;
      }
  ...
  exports.CoffeeAwaitReturn = CoffeeAwaitReturn = class CoffeeAwaitReturn extends Return {
    compileNode(o) {
      if (o.scope.parent == null) {
        this.error('es6await can only occur inside functions');
      }
      return super.compileNode(o);
    }
  ...
  exports.SuperCall = SuperCall = (function() {
    class SuperCall extends Call {
      ...
      compileNode(o) {
        var icedIterator, ref, ref1, ref2, ref3, ref4, replacement, rhs, superCall, supval;
        icedIterator = (ref1 = o.scope) != null ? (ref2 = ref1.parent) != null ? (ref3 = ref2.method) != null ? ref3.icedIterator : void 0 : void 0 : void 0;
        if (icedIterator != null) {
          supval = new Value(new IdentifierLiteral('__super'));
          supval.add(new Access(new PropertyName('call')));
          rhs = new Call(supval, [new Value(new ThisLiteral)].concat(this.args));
          return rhs.compileNode(o);
        }
        if (!((ref4 = this.expressions) != null ? ref4.length : void 0)) {
          return super.compileNode(o);
        }
  ...
  exports.Super = Super = (function() {
    class Super extends Base {
      ...
      compileNode(o) {
        var fragments, icedIterator, method, name, nref, ref1, ref2, ref3, ref4, ref5, salvagedComments, variable;
        ...
        icedIterator = (ref1 = o.scope) != null ? (ref2 = ref1.parent) != null ? (ref3 = ref2.method) != null ? ref3.icedIterator : void 0 : void 0 : void 0;
        if (icedIterator != null) {
          this.error("cannot use super in iced method");
        }
        ...
        if ((ref4 = this.accessor) != null ? (ref5 = ref4.name) != null ? ref5.comments : void 0 : void 0) {
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      compileNode(o) {
        var answer, i, idt, indent, isCompact, j, join, k, key, lastNode, len1, len2, len3, len4, node, prop, props, q, r, ref1, unwrappedVal, value;
        props = this.properties;
        if (this.generated) {
          for (j = 0, len1 = props.length; j < len1; j++) {
            node = props[j];
        ...
        for (i = r = 0, len4 = props.length; r < len4; i = ++r) {
          prop = props[i];
      ...
      icedToSlot(i) {
        var access, j, len1, prop, ref1, results;
        ref1 = this.properties;
        results = [];
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          prop = ref1[j];
  ...
  exports.Arr = Arr = (function() {
    class Arr extends Base {
      ...
      compileNode(o) {
        var answer, compiledObjs, fragment, fragmentIndex, fragments, includesLineCommentsOnNonFirstElement, index, j, k, len1, len2, len3, len4, len5, obj, objIndex, q, r, ref1, t, unwrappedObj;
        if (!this.objects.length) {
        ...
        for (index = k = 0, len2 = compiledObjs.length; k < len2; index = ++k) {
          ...
          for (q = 0, len3 = fragments.length; q < len3; q++) {
            fragment = fragments[q];
        ...
        if (includesLineCommentsOnNonFirstElement || indexOf.call(fragmentsToText(answer), '\n') >= 0) {
          for (fragmentIndex = r = 0, len4 = answer.length; r < len4; fragmentIndex = ++r) {
          ...
          for (t = 0, len5 = answer.length; t < len5; t++) {
            fragment = answer[t];
            if (fragment.isHereComment) {
      ...
      walkBody() {
        ...
        if (initializer.length !== expressions.length) {
          this.body.expressions = (function() {
            var len3, q, results;
            results = [];
            for (q = 0, len3 = initializer.length; q < len3; q++) {
              expression = initializer[q];
    ...
    class Code extends Base {
      constructor(params, body, funcGlyph) {
        ...
        this.body.traverseChildren(false, (node) => {
          ...
          if ((node instanceof Op && node.isCoffeeAwait()) || node instanceof CoffeeAwaitReturn) {
            this.isAsync = true;
          }
      ...
      compileNode(o) {
        ...
        answer = this.joinFragmentArrays((function() {
          var len4, r, results;
          results = [];
          for (r = 0, len4 = modifiers.length; r < len4; r++) {
            m = modifiers[r];
      ...
      icedTransform() {
        var body, call, code, codeval, f, nxt, rhs, sup;
        if (this.isGenerator) {
        ...
        if (this.isMethod) {
          ...
          sup.add(this.name);
          body.push(new Assign(f, sup, null, {
            param: 'alwaysDeclare'
          }));
        }
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      compileNode(o) {
        ...
        if (this.isYield() || this.isCoffeeAwait()) {
  ...
  exports.Defer = Defer = (function() {
    class Defer extends Base {
      ...
      makeAssignFn(o) {
        var a, args, assign, assignments, block, call, func, i, i_lit, inner_fn, j, len1, outer_block, outer_fn, prop, ref1, s, slot;
          ...
          if (s.splat) { // case 4
            ...
            if (!s.suffix) { // case 1
              ...
              if (s.suffix instanceof Index) { // case 3
                ...
                args.push(s.suffix.index); // case 2
              } else {
                prop = s.suffix;
              }
              slot.add(prop);
      ...
      compileNode(o) {
        var call, j, len1, name, ref1, scope, v;
  ...
  //### Await
  exports.IcedAwait = IcedAwait = (function() {
    class IcedAwait extends Base {
      constructor(body1) {
        super();
        this.body = body1;
      }
      ...
      transform(o) {
        var assign, assignments, body, call, cb_assignment, cb_lhs, cb_rhs, cls, fn_assignment, fn_lhs, fn_rhs, func_assignment, func_lhs, func_rhs, lhs, meth, n, name, ref1, ref2, rhs, trace;
        body = this.body;
        ...
        assignments = [];
        if (n = (ref1 = this.icedParentFunc) != null ? ref1.icedPassedDeferral : void 0) {
        ...
        if (n = (ref2 = this.icedParentFunc) != null ? ref2.icedTraceName() : void 0) {
    ...
    IcedAwait.prototype.children = ['body'];

    IcedAwait.prototype.isStatement = YES;

    IcedAwait.prototype.makeReturn = THIS;
  ...
  IcedRuntime = class IcedRuntime extends Block {
