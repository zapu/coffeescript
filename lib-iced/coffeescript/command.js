...
(function() {
  ...
  compilePath = function(source, topLevel, base) {
    ...
    if (stats.isDirectory()) {
      ...
      return results;
    } else if (topLevel || helpers.isCoffeeOrIced(source)) {
      sources.push(source);
